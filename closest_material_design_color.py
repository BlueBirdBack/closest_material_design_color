...
def closest_material_color(hex_input_color):
    input_rgb = hex_to_rgb(hex_input_color)
    input_lab = rgb_to_lab(input_rgb)

    closest_color = None
    min_difference = float("inf")

    for color_name, color_hex in material_design_colors.items():
        material_rgb = hex_to_rgb(color_hex)
        material_lab = rgb_to_lab(material_rgb)
        difference = color_difference(input_lab, material_lab)
